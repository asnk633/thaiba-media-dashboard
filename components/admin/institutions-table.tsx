      ...
      <CardContent>
        ...
        <div className="space-y-4">
          {filteredInstitutions.map((institution) => (
            <div key={institution.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  onClick={() => {
                    ...
                    setFormData({ name: institution.name, contact_email: institution.contact_email })
